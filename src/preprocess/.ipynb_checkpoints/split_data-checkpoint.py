...
def main(data_combo):
    ...
    output_dir = os.path.join("..", "..", "processed", "split_data")
    ...
    for k in [5, 10]:
        ...
        for fold, (train_index, test_index) in enumerate(kf.split(X, y), start=1):
            ...
            # Save indices to text files just once. Currently, uncommenting will save the same indices for everything
            # Which is redundant because all the data across sets should be split the same for number of folds.
